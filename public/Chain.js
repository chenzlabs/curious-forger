...
Fullik.Chain = function( color ){
    ...
    this.mTargetChainNumber = -1;
    this.mTargetBoneNumber = -1;
...
Fullik.Chain.prototype = {
    ...
    targetStructure: function (structure, chainNumber, boneNumber) {
        ...
        this.mTargetChainNumber = chainNumber;
        this.mTargetBoneNumber = boneNumber;
    },
    ...
    getTargetBoneNumber:function(){
        return this.mTargetBoneNumber;
    },
    getTargetChainNumber:function(){
        return this.mTargetChainNumber;
    },
    ...
    solveIKForward : function( target ){
...
if (i > 0) {              
    ...
    solveIKBackward : function( target ){
    ...
    solveIK : function( target ){
        ...
        this.solveIKForward(target);

        this.solveIKBackward(target);
